    ...
    <main className="flex min-h-screen flex-col p-4 md:p-6 bg-gray-50">
      ...
      <div className="flex h-20 shrink-0 items-end rounded-lg bg-primary p-4 md:h-52 shadow-lg relative">
        ...
        <a
          ...
          className="absolute top-4 right-4 flex items-center gap-2 bg-white border border-gray-200 rounded-full px-3 py-1 shadow hover:bg-gray-50 transition-colors z-20"
          title="Ver en GitHub"
        >
          {/* GitHub SVG */}
          ...
          <span className="text-gray-800 text-sm font-medium">{githubStars !== null ? githubStars : '...'} ⭐</span>
        </a>
      </div>
